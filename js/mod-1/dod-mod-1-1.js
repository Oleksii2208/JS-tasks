...
// const city = "Дніпро";
// const liveCity = `Я живу в місті ${city}`;
...
// const price = 500;
// const totalPrice = `Ціна: ${price} грн`;
...
// const firstName = "Kost";
// const lastName = "Oleksii";
...
// const someString = "Я живу у Дніпрі";
...
// const str1 = "HELLO";
// const str2 = "WORLD";
// const lastLetters = str1[str1.length - 1] + str2[str2.length - 1];
