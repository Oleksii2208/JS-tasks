...
// якщо сума до сплати перевищує кількість кредитів на рахунку клієнта, функція має
// повертати рядок "Insufficient funds!"
...
//   const totalPriceOrdered = quantity * pricePerDroid;
//   if (totalPriceOrdered > customerCredits) {
//     return "Insufficient funds!";
//   } else {
//     return `You ordered ${quantity} droids worth ${totalPriceOrdered} credits!`;
//   }
// }
