...
// const heroName = (heroes) => heroes.map((hero) => hero.name);
// console.log(heroName(heroes));

//    gender дорівнює 'Male'.
// 1. Напиши функцію, яка приймає масив героїв та повертає масив героїв, у яких
//    eyeColor дорівнює 'Blue'.

// const eyeBlueColor = (heroes) =>
//   heroes.filter((hero) => hero.appearance.eyeColor === "Blue");
// console.log(eyeBlueColor(heroes));

// 1. Напиши функцію, яка приймає масив героїв та повертає масив героїв, у яких
//    hairColor дорівнює 'Black'.

// const heroWithHairColor = (heroes) =>
//   heroes.filter((hero) => hero.appearance.hairColor === "Black");
// console.log(heroWithHairColor(heroes));

// 1. Напиши функцію, яка приймає масив героїв та повертає масив героїв, у яких
//    race дорівнює 'Human'.

// const raceHero = (heroes) =>
//   heroes.filter((hero) => hero.appearance.race === "Human");
// console.log(raceHero(heroes));

// 1. Напиши функцію, яка приймає масив героїв та повертає масив героїв, у яких
//    publisher дорівнює 'Marvel Comics'.

// const heroHasMarvel = (heroes) => {
//   return heroes.filter((hero) => {
//     return hero.biography.publisher === "Marvel Comics";
//   });
// };

// console.log(heroHasMarvel(heroes));

// 1. Напиши функцію, яка приймає масив героїв та повертає масив героїв, у яких
//    powerstats.power більше ніж 80.

// const heroPower = (heroes) => {
...
// const heroIntelligence = (heroes) =>
//   heroes.filter((hero) => hero.powerstats.intelligence < 50);
// console.log(heroIntelligence(heroes));

// 1. Напиши функцію, яка приймає масив героїв та повертає героя з name рівним
//    'Doctor Strange'.

// const searchHero = (heroes) =>
//   heroes.find((hero) => hero.name === "Doctor Strange");

// console.log(searchHero(heroes));

// 1. Напиши функцію, яка приймає масив героїв та повертає героя з максимальним
//    значенням powerstats.strength.

// const heroMaxStrength = (heroes) => {
//   const strength = heroes.map((hero) => hero.powerstats.strength);
//   const maxStrength = Math.max(...strength);
//   console.log(strength);
//   return maxStrength;
// };
// console.log(heroMaxStrength(heroes));

// 1. Напиши функцію, яка приймає масив героїв та повертає героя з мінімальним
//    значенням powerstats.speed.

// const minSpeedHero = (heroes) => {
//   const speed = heroes.map((hero) => hero.powerstats.speed);
//   const minSpeed = Math.min(...speed);
//   return minSpeed;
// };
// console.log(minSpeedHero(heroes));

// 1. Напиши функцію, яка приймає масив героїв та повертає масив героїв, у яких
//    appearance.weight[1] менше 75 кг.

// const appearanceWeight = (heroes, arr) => {
//   const res = heroes.filter(
//     (hero) => Number.parseInt(hero.appearance.weight[1]) < 75
//   );
//   return res;
// };

// console.log(appearanceWeight(heroes));

// 1. Напиши функцію, яка приймає масив героїв та повертає масив героїв, у яких
//    appearance.height[1] більше 180 см.

// const appearanceHeight = (heroes) => {
//   const res = heroes.filter(
//     (hero) => Number.parseInt(hero.appearance.height[1]) > 180
//   );
//   return res;
// };
// console.log(appearanceHeight(heroes));

// 1. Напиши функцію, яка приймає масив героїв та повертає масив назв
//    biography.firstAppearance усіх героїв.

// const biography = (heroes) =>
//   heroes.map((hero) => hero.biography.firstAppearance);
// console.log(biography(heroes));

// 1. Напиши функцію, яка приймає масив героїв та повертає масив назв
//    work.occupation усіх героїв.

// const occupation = (heroes) => heroes.map((hero) => hero.work.occupation);
// console.log(occupation(heroes));

// 1. Напиши функцію, яка приймає масив героїв та сортує його за зростанням
//    powerstats.intelligence.

// const intelligence = (heroes) =>
//   heroes.toSorted(
//     (a, b) => a.powerstats.intelligence - b.powerstats.intelligence
//   );
// console.log(intelligence(heroes));

// 1. Напиши функцію, яка приймає масив героїв та сортує його за спаданням
//    powerstats.power.

// const powerHero = (heroes) =>
//   heroes.toSorted((a, b) => b.powerstats.power - a.powerstats.power);
// console.log(powerHero(heroes));

// 1. Напиши функцію, яка приймає масив героїв та сортує його за алфавітом по name.

// const nameHero = (heroes) =>
//   heroes.toSorted((a, b) => a.name.localeCompare(b.name));
// console.log(nameHero(heroes));

// 1. Напиши функцію, яка приймає масив героїв та перевіряє, чи є хоча б один герой
//    з alignment рівним 'bad'.)

// const alignmentBadHero = (heroes) =>
//   heroes.some((hero) => hero.biography.alignment === "bad");
// console.log(alignmentBadHero(heroes));

// 1. Напиши функцію, яка приймає масив героїв та перевіряє, чи всі герої мають
//    alignment рівним 'good'.

// const alignmentGoodHero = (heroes) =>
//   heroes.every((hero) => hero.biography.alignment === "good");
// console.log(alignmentGoodHero(heroes));

// 1. Напиши функцію, яка приймає масив героїв та перевіряє, чи є хоча б один герой
//    з powerstats.intelligence рівним 100.

// const intelligenceHard = (heroes) =>
//   heroes.some((hero) => hero.powerstats.intelligence === 100);

// console.log(intelligenceHard(heroes));

// 1. Напиши функцію, яка приймає масив героїв та перевіряє, чи всі герої мають
//    race, відмінний від null.

// const race = (heroes) => heroes.every((hero) => hero.appearance.race !== null);
// console.log(race(heroes));

// 1. Напиши функцію, яка приймає масив героїв та перевіряє, чи є хоча б один герой
//    вагою більше ніж 150 кг.

// const weightHero = (heroes) =>
//   heroes.some((hero) => Number.parseInt(hero.appearance.weight[1]) > 150);

// console.log(weightHero(heroes));

// 1. Напиши функцію, яка приймає масив героїв та повертає індекс героя з id
//    рівним 226.

// const idHero = (heroes) => {
//   const res = heroes.map((hero) => hero.id).indexOf(226);
//   return res;
// };
// console.log(idHero(heroes));

// 1. Напиши функцію, яка приймає масив героїв та повертає масив довжин масиву
//    aliases кожного героя.

// const aliases = (heroes) => heroes.map((hero) => hero.biography.aliases.length);
// console.log(aliases(heroes));

// 1. Напиши функцію, яка приймає масив героїв та повертає героя, у якого найбільше
//    aliases.
//!
// const aliasesHard = (heroes) => {
//   const copy = [...heroes];
//   const aliases = copy.map((hero) => hero.biography.aliases.length);
//   const res = Math.max(...aliases);
//   return res;
// };
// console.log(aliasesHard(heroes));

// 1. Напиши функцію, яка приймає масив героїв та повертає масив героїв, у яких
//    кількість aliases більше ніж 3.

// const aliases = (heroes) => {
//   const copy = [...heroes];
//   const res = copy.filter((hero) => hero.biography.aliases.length > 3);
//   return res;
// };
// console.log(aliases(heroes));
...
// const occupationHero = (heroes) =>
//   heroes.filter((hero) => hero.work.occupation === "-");
// console.log(occupationHero(heroes));

// 1. Напиши функцію, яка приймає масив героїв та повертає масив героїв, які мають
//    у groupAffiliation згадку про 'Avengers'.
//!
// const hasAvengers = (heroes) => {
//   const copy = [...heroes];
//   const res = copy.filter((hero) => hero.connections.groupAffiliation);
//   return res;
// };
// console.log(hasAvengers(heroes));
...
// const ageHero = (heroes)=>heroes.filter((hero)=>hero)
...
// const raceAnaIntelligence = (heroes) =>
//   heroes
//     .filter(
//       (hero) =>
//         hero.appearance.race === "Human" && hero.powerstats.intelligence > 70
//     )
//     .toSorted((a, b) => a.powerstats.intelligence - b.powerstats.intelligence)
//     .map((hero) => hero.name);

// console.log(raceAnaIntelligence(heroes));
